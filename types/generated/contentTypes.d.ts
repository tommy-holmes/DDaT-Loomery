...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    memberSpecificContent: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPointOfInterestPointOfInterest
  ...
  attributes: {
    ...
    integerID: Attribute.Integer;
    latitude: Attribute.Float;
    longitude: Attribute.Float;
    libCalID: Attribute.Integer;
    mapLink: Attribute.String;
    photo: Attribute.Media;
    studySpaces: Attribute.Enumeration<
      ['none', 'bookable', 'non-bookable', 'both']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'none'>;
    zoomLevel: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 0;
        max: 22;
      }>;
    ...
    parentPOI: Attribute.Relation<
      'api::point-of-interest.point-of-interest',
      'manyToOne',
      'api::point-of-interest.point-of-interest'
    >;
    childrenPOI: Attribute.Relation<
      'api::point-of-interest.point-of-interest',
      'oneToMany',
      'api::point-of-interest.point-of-interest'
    >;
    busyness: Attribute.Component<'busyness.location'>;
    description: Attribute.Text;
    openingTimesUrl: Attribute.String;
...
export interface ApiStvStv extends Schema.CollectionType {
  ...
  attributes: {
    ...
    includedInBasicMembership: Attribute.Boolean & Attribute.Required;
    bookable: Attribute.Boolean & Attribute.Required;
    url: Attribute.String & Attribute.Required;
    image: Attribute.Media & Attribute.Required;
    priority: Attribute.Integer;
    description: Attribute.Text & Attribute.Required;
    location: Attribute.Relation<
      ...
      'api::point-of-interest.point-of-interest'
    >;
    openingTimes: Attribute.Text;
    buttonText: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::stv.stv', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::stv.stv', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiTermTerm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isExam: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
